 ...
 * 使用命令keytool -printcert -rfc -file srca.cer导出证书为字符串，
 * 然后将字符串转换为输入流，如果使用的是okhttp可以直接使用
 * new Buffer().writeUtf8(s).inputStream()
 *
 * 使用参考:http://my.oschina.net/u/2437072/blog/669041
 *
 * @since 16/8/16
 */
